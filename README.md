...
- **TCGA virtual ST atlas** — DeepSpot-M predicted transcriptome-wide ST for TCGA H&E (~28.7k slides / 32 cancer types). [![Paper](https://img.shields.io/badge/Paper-medRxiv%202026-6A5ACD.svg)](https://www.medrxiv.org/content/10.64898/2026.06.19.26356060v1) [![Dataset](https://img.shields.io/badge/Dataset-HuggingFace-orange.svg)](https://huggingface.co/datasets/ratschlab/TCGA_virtual_spatial_transcriptomics_atlas) [![Code](https://img.shields.io/badge/Code-GitHub-green.svg)](https://github.com/ratschlab/DeepSpotM)
- **HEST Xenium virtual ST** — DeepSpot-M predicted transcriptome-wide ST for 59 HEST-1k Xenium samples (~13.3M cells). [![Paper](https://img.shields.io/badge/Paper-medRxiv%202026-6A5ACD.svg)](https://www.medrxiv.org/content/10.64898/2026.06.19.26356060v1) [![Dataset](https://img.shields.io/badge/Dataset-HuggingFace-orange.svg)](https://huggingface.co/datasets/ratschlab/HEST_Xenium_virtual_spatial_transcriptomics) [![Code](https://img.shields.io/badge/Code-GitHub-green.svg)](https://github.com/ratschlab/DeepSpotM)
...
- **SMMILe** — SMMILe enables accurate spatial quantification in digital pathology using MIL. [![Paper](https://img.shields.io/badge/Paper-Nature%20Cancer%202025-1f77b4.svg)](https://www.nature.com/articles/s43018-025-01060-8)
...
- **DeepSpot-M** — multimodal FM for transcriptome-wide virtual ST from histology. [![Paper](https://img.shields.io/badge/Paper-medRxiv%202026-6A5ACD.svg)](https://www.medrxiv.org/content/10.64898/2026.06.19.26356060v1) [![Code](https://img.shields.io/badge/Code-GitHub-green.svg)](https://github.com/ratschlab/DeepSpotM)
- **DeepSpot2Cell** — virtual single-cell ST from H&E with spot-level supervision. [![Paper](https://img.shields.io/badge/Paper-NeurIPS%202025-1f77b4.svg)](https://openreview.net/forum?id=ofCkwXQKaz) [![Code](https://img.shields.io/badge/Code-GitHub-green.svg)](https://github.com/ratschlab/DeepSpot2Cell)
- **AESTETIK** — multi-modal ST representation learning with topology and morphology. [![Paper](https://img.shields.io/badge/Paper-Bioinformatics%202026-1f77b4.svg)](https://academic.oup.com/bioinformatics/advance-article/doi/10.1093/bioinformatics/btag316/8692433) [![Code](https://img.shields.io/badge/Code-GitHub-green.svg)](https://github.com/ratschlab/aestetik)
...
- **PathDiff** — text- and mask-conditioned histopathology synthesis. [![Paper](https://img.shields.io/badge/Paper-ICCV%202025-d62728.svg)](https://openaccess.thecvf.com/content/ICCV2025/papers/Bhosale_PathDiff_Histopathology_Image_Synthesis_with_Unpaired_Text_and_Mask_Conditions_ICCV_2025_paper.pdf)[![Code](https://img.shields.io/badge/Code-GitHub-green.svg)](https://github.com/bhosalems/PathDiff)
